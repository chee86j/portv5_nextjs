...
import Project4 from "../public/project-4v2.png";
        ...
        <div className="about-containers">
          ...
          >
            <div className="article-container">
              <Image src={Project1} alt="Project 1" className="project-img" />
            </div>
          ...
          >
            <div className="article-container">
              <Image src={Project2} alt="Project 2" className="project-img" />
            </div>
            <h2 className="experience-sub-title project-title">
              Reel Relations
            </h2>
          ...
          >
            <div className="article-container">
              <Image src={Project3} alt="Project 3" className="project-img" />
            </div>
            <h2 className="experience-sub-title project-title">
              Tetris Beats TS
            </h2>
          ...
          >
            <div className="article-container">
              <Image src={Project4} alt="Project 4" className="project-img" />
            </div>
            <h2 className="experience-sub-title project-title">
              Manny&rsquo;s Seamless Gutters
            </h2>
            <p className="project-text">
